(function (factory) {
    ...
    L.Control.Rotate = L.Control.extend({
        ...
        onAdd: function(map) {
            ...
            arrow.style.backgroundImage = `url("data:image/svg+xml;charset=utf-8,%3Csvg width='29' height='29' viewBox='0 0 29 29' xmlns='http://www.w3.org/2000/svg' fill='%23333'%3E%3Cpath d='M10.5 14l4-8 4 8h-8z'/%3E%3Cpath d='M10.5 16l4 8 4-8h-8z' fill='%23333'/%3E%3C/svg%3E")`;
        ...
        _restyle: function() {
            if (this._map.options.rotate) {
                ...
                if (map.compassBearing.enabled()) {
                    ...
                    this._link.style.backgroundColor = '#ddd';
                    if (this.options.closeOnZeroBearing && map.getBearing() === 0) {
